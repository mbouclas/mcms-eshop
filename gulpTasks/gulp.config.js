...
var Config = {
    ...
    publicDirJs : path.join(InstallationDir,'public/vendor/mcms/eshop/js'),
    publicDirCss : path.join(InstallationDir,'public/vendor/mcms/eshop/css'),
    publicDirImg : path.join(InstallationDir,'public/vendor/mcms/eshop/img'),
    publicDirTemplates : path.join(InstallationDir,'public/vendor/mcms/eshop/app/templates')
};
